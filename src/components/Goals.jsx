...
const Goals = () => {
  ...
  const GoalCard = useCallback(({ goal, index, side }) => {
    const Icon = goal.icon;
    ...
    return (
      <motion.div
        ...
        style={{
          padding: isMobile ? '24px' : '32px',
          background: `linear-gradient(135deg, rgba(0, 0, 0, 0.7) 0%, ${goal.color}12 100%)`,
          ...
          position: 'relative',
          overflow: 'hidden',
          boxShadow: `0 8px 32px ${goal.color}15, inset 0 1px 0 rgba(255,255,255,0.1)`,
        }}
      >
        {/* Animated Hover Glow */}
        <motion.div
          ...
          style={{
            position: 'absolute',
            inset: 0,
            background: `radial-gradient(circle at ${isLeft ? 'left' : 'right'}, ${goal.color}20 0%, transparent 60%)`,
            pointerEvents: 'none',
          }}
        />
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            backgroundImage: `linear-gradient(${goal.color}08 1px, transparent 1px), linear-gradient(90deg, ${goal.color}08 1px, transparent 1px)`,
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '18px', position: 'relative', zIndex: 1 }}>
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: `0 4px 20px ${goal.color}25`,
              position: 'relative',
            }}
          >
            {/* Icon Pulse Ring */}
            ...
            <Icon
              ...
              style={{
                color: goal.color,
                filter: `drop-shadow(0 2px 8px ${goal.color}60)`,
              }}
            />
          </motion.div>
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: '2px',
            marginTop: '20px',
            boxShadow: `0 0 15px ${goal.color}70`,
            position: 'relative',
            zIndex: 1,
          }}
        />
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Building a strong community through innovative, high-quality content
          </p>
        </motion.div>
        ...
        >
          ...
          >
            {goals.slice(0, 2).map((goal, index) => (
              <GoalCard key={goal.id} goal={goal} index={index} side="left" />
            ))}
          </div>
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                overflow: 'hidden',
                border: '3px solid rgba(0, 102, 255, 0.6)',
                boxShadow: '0 25px 70px rgba(0, 0, 0, 0.9), 0 0 100px rgba(0, 102, 255, 0.3)',
                zIndex: 1,
              }}
            >
              <img
              ...
              <div
                style={{
                  position: 'absolute',
                  inset: 0,
                  background: 'linear-gradient(135deg, rgba(0, 102, 255, 0.12) 0%, rgba(196, 0, 255, 0.12) 100%)',
                  mixBlendMode: 'overlay',
                  pointerEvents: 'none',
                }}
              />
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 32px rgba(0, 0, 0, 0.9), 0 0 40px rgba(0, 102, 255, 0.3)',
                }}
              >
                <div style={{ textAlign: 'center' }}>
                  <motion.div 
                  ...
                  <div style={{ fontSize: '11px', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.5px', marginTop: '2px' }}>Goals</div>
                </div>
                <div style={{ width: '1px', background: 'rgba(255,255,255,0.2)' }} />
                <div style={{ textAlign: 'center' }}>
                  <motion.div 
                    ...
                    style={{ 
                      ...
                      color: '#C400FF', 
                      fontFamily: 'Poppins, sans-serif',
                      textShadow: '0 0 20px rgba(196, 0, 255, 0.8)',
                    }}
                  >
                    2026
                  </motion.div>
                  <div style={{ fontSize: '11px', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.5px', marginTop: '2px' }}>Year</div>
                </div>
              </motion.div>
            </motion.div>
          </motion.div>
          ...
          >
            {goals.slice(2, 5).map((goal, index) => (
              <GoalCard key={goal.id} goal={goal} index={index} side="right" />
            ))}
          </div>
        </div>
